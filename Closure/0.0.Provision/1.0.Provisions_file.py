...
PROVISIONS_FILE_PATH = "Closure/0.0.Provision/1.0.Provisions.xlsx"
Provisions_file = Workbook()

# Todo :
    # Formatting DB columns worksheet
...
def Reference_worksheet() :
    ...
    Internal_formating(Worksheet = reference_ws, Range = "AN11:AO12",Type_border = "hair")
    Right_border_formating(Worksheet = reference_ws, Range = "AN11:AO12", Type_border = "dotted")
    External_formatting(Worksheet = reference_ws, Range = "AN11:AO12", Type_border = "thin")
    ...
    Bottom_border_formating(Worksheet = reference_ws, Range = "BA1:BB11", Type_border = "dotted")  
    Right_border_formating(Worksheet = reference_ws, Range = "BA1:BB11", Type_border = "hair")  
    External_formatting(Worksheet = reference_ws, Range = "BA1:BB11", Type_border = "thin")
    ...
    Bottom_border_formating(Worksheet = reference_ws, Range = "BF1:BH10", Type_border = "dotted")  
    Right_border_formating(Worksheet = reference_ws, Range = "BF1:BH10", Type_border = "hair")  
    External_formatting(Worksheet = reference_ws, Range = "BF1:BH10", Type_border = "thin")

    Bottom_border_formating(Worksheet = reference_ws, Range = "BL1:BM10", Type_border = "dotted")  
    Right_border_formating(Worksheet = reference_ws, Range = "BL1:BM10", Type_border = "hair")  
    External_formatting(Worksheet = reference_ws, Range = "BL1:BM10", Type_border = "thin")
...
def DB_worsheet():
    ...
    source_workbook = load_workbook('Closure/0.0.Provision/0.0.Assets/income_statement_DBGenerator_FNP.xlsx')
    source_sheet = source_workbook['BDD']

    destination_workbook = load_workbook("Closure/0.0.Provision/1.0.Provisions.xlsx")
    if "BDD" in destination_workbook.sheetnames:
        destination_sheet = destination_workbook['BDD']
    else:
        destination_sheet = destination_workbook.create_sheet("BDD")
    ...
    destination_sheet.column_dimensions["A"].width = len("Nature comptable") + 1;
    destination_sheet.column_dimensions["B"].width = len("Fournitures non stockables (eau, énergie) - Eau") + 1;
    destination_sheet.column_dimensions["C"].width = len("Centre de coût") + 1;
    destination_sheet.column_dimensions["D"].width = len("Designation centre de coût") + 1;
    destination_sheet.column_dimensions["E"].width = len("Centre de profit") + 1;
    destination_sheet.column_dimensions["F"].width = len("Designation centre de profit") + 1;
    destination_sheet.column_dimensions["G"].width = len("Montant") + 1;
    destination_sheet.column_dimensions["H"].width = len("Type Piece") + 1;
    destination_sheet.column_dimensions["I"].width = len("Nom") + 7;
    destination_sheet.column_dimensions["J"].width = len("Prenom") + 7;
    destination_sheet.column_dimensions["K"].width = len("Matricule") + 1;

    destination_sheet.column_dimensions["L"].width = len("Periode d'effet") + 1;
    for cell in destination_sheet["L"]:
        cell.number_format = "DD/MM/YYYY"

    destination_sheet.column_dimensions["M"].width = len("Debut periode") + 1;
    for cell in destination_sheet["M"]:
        cell.number_format = "DD/MM/YYYY"

    destination_sheet.column_dimensions["N"].width = len("Fin periode") + 1;
    for cell in destination_sheet["N"]:
        cell.number_format = "DD/MM/YYYY"

    destination_sheet.column_dimensions["O"].width = len("N° piece reference") + 1;
    destination_sheet.column_dimensions["O"].width = len("Utilisateur ecriture") + 1;

    destination_sheet.column_dimensions["Q"].width = len("Date piece") + 1;
    for cell in destination_sheet["Q"]:
        cell.number_format = "DD/MM/YYYY"
    destination_sheet.column_dimensions["R"].width = len("Date comptable") + 1;
    for cell in destination_sheet["R"]:
        cell.number_format = "DD/MM/YYYY"

    destination_sheet.column_dimensions["S"].width = len("Date de saisie") + 1;
    for cell in destination_sheet["S"]:
        cell.number_format = "DD/MM/YYYY"

    destination_sheet.column_dimensions["T"].width = len("Compte contre partie") + 1;
    destination_sheet.column_dimensions["U"].width = len("Fournisseurs - Achats de biens et prestations de services");
    destination_sheet.column_dimensions["V"].width = len("7000000000000") + 1;
    destination_sheet.column_dimensions["W"].width = len("Commentaire ecriture") + 1;
    destination_sheet.column_dimensions["X"].width = len("N° contre passation") + 1;
    destination_sheet.column_dimensions["Y"].width = len("Commentaire contre passation") + 1;
    destination_sheet.column_dimensions["Z"].width = len("Devise") + 1;
    destination_sheet.column_dimensions["AA"].width = len("Devise") + 1;
    destination_sheet.column_dimensions["AB"].width = len("Date convertion") + 1;
    destination_sheet.column_dimensions["AC"].width = len("Taux convertion") + 1;
    destination_sheet.column_dimensions["AD"].width = len("Source convertion") + 1;
    destination_sheet.column_dimensions["AE"].width = len("Societe") + 1;
    destination_sheet.column_dimensions["AF"].width = len("Designation societe") + 1;
    destination_sheet.column_dimensions["AG"].width = len("Unité de quantité") + 1;
    destination_sheet.column_dimensions["AH"].width = len("Quantité") + 1;
    destination_sheet.column_dimensions["AI"].width = len("Taux unité de quantité") + 1;
    destination_sheet.column_dimensions["AJ"].width = len("Code mouvement") + 1;
    destination_sheet.column_dimensions["AK"].width = len("Designation mouvement") + 1;

    destination_workbook.save(PROVISIONS_FILE_PATH)
